...
using ShopMicroservices.Customers.Persistance.Context;
using System.Linq.Expressions;


namespace ShopMicroservices.Customers.Persistance.Repositories
{
    public class CustomerRepository : ICustomersRepository
    {
        ...
        public Domain.Entities.Customers GetEntityByID(int id)
        {
            ...
            try
            {
                ...
                {
                    throw new ShopMicroservices.Customers.Persistance.Exceptions.CustomerExceptions("El customer no se encvuentra registrado");
                }
                return customers;
            }
            catch (Exception e)
